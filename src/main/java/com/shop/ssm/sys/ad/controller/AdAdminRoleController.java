...
public class AdAdminRoleController {
    ...
    public void inti(Model model){
        ...
        model.addAttribute("adAdmin",adAdmin);
    }
    ...
    public ModelAndView adminOfRole(AdAdmin adAdmin, ModelAndView modelAndView, HttpServletRequest req){
        PageBean pageBean = new PageBean();
        pageBean.setRequest(req);
        List<AdAdmin> adAdmins = adminRoleService.adminOfRole(adAdmin, pageBean);

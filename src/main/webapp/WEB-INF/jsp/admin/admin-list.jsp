...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tbody>
        <c:forEach items="${adminOfRoles}" var="aor">
        <tr class="text-c">
            ...
            <td>${aor.aemail}</td>
            <td>
                <c:forEach items="${aor.adRoles}" var="aRl">
                    ${aRl.rname}
                </c:forEach>
            </td>
            <td>${aor.atime}</td>
            <td class="td-status"><span class="label label-success radius">${aor.adState.sname}</span></td>
    ...
    <z:page pageBean="${adAdPageBean}"></z:page>
</div>
<!--_footer 作为公共模版分离出去-->

...
<div class="page-container">
    <div class="text-c">
        <f:form class="Huiform" method="post" action="${ctx}/admin/AdPer/listPer" target="_self" modelAttribute="adPermissions">
            <f:input type="text" class="input-text" style="width:250px" placeholder="权限名称" id="" name="" path="pname"></f:input>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tbody>
        <c:forEach var="pl" items="${adPermissionsList}">
        <tr class="text-c">

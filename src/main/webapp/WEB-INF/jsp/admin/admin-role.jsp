...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray"><span class="l"> <a href="javascript:;" onclick="datadel()"
            ...
            class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="javascript:;"
                                                          onclick="admin_role_add('添加角色','${ctx}/admin/AdPer/listPsType?path=role','800')"><i
    ...
    <table class="table table-border table-bordered table-hover table-bg">
        ...
        <tbody>
        <c:forEach var="roa" items="${roleOfAdmins}">
        <tr class="text-c">
            <td><input type="checkbox" value="" name=""></td>
            <td>${roa.rid}</td>
            <td>${roa.rname}</td>
            <td>
                <c:forEach var="rAd" items="${roa.adAdmins}">
                    <a href="#">${rAd.aname}</a>
                </c:forEach>
            </td>
            <td>${roa.rdescribe}</td>
    ...
    <z:page pageBean="${adRlPageBean}"></z:page>
</div>
<!--_footer 作为公共模版分离出去-->
